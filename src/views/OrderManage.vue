      ...
      <div class="head">
        <van-sticky>
          <div class="tab_wrap" :offset-top="30">
            <div class="tab_item" :class="{ tab_active: tab == 1 }" @click="tab = 1">待付款</div>
            <div class="tab_item" :class="{ tab_active: tab == 2 }" @click="tab = 2">待确认</div>
            <div class="tab_item" :class="{ tab_active: tab == 3 }" @click="tab = 3">已完成</div>
          </div>
        </van-sticky>
      </div>
    </div>
